export const experiences = [
  ...
  },
  {
    ...
    location: "Remote",
    description: "Designed and developed carryzo.in, a responsive logistics website. Integrated interactive components, optimized load times, and collaborated with clients for iterative updates.",
    technologies: ["React.js", "Tailwind CSS", "JavaScript", "Framer Motion"],
    type: "Contract",
    achievements: [
      "Built responsive logistics platform with modern UI",
      "Optimized website performance and load times",
      "Collaborated directly with clients for feature updates",
