...
`;
    ...
    const fallbackBody = `# Rahul Verma

> Freelance Full Stack Developer in Patna, Bihar specializing in React, Next.js, Node.js, and MongoDB.
...
## Resources
- [Sitemap](${siteUrl}/sitemap.xml): Complete machine-readable list of public URLs
`;
